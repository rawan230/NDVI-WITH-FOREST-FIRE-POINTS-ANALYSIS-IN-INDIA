...
\newtcolorbox{novelbox}[1]{
  ...
  title     = {\faLeaf\quad Novel Contribution: #1},
...
\begin{novelbox}{Novel Contribution 1: STL Decomposition + Mann--Kendall}
...
\begin{novelbox}{Novel Contribution 3: Cumulative Vegetation Stress Index}
\begin{itemize}[leftmargin=1.5em,itemsep=2pt]
